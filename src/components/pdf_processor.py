"""PDF text extraction and chunking module for the PDF RAG Application.

This module provides functionality to:
1. Extract text from PDF documents using PyMuPDF
2. Split text into semantic chunks based on document structure
3. Process multiple PDFs for indexing in the vector store
"""
