"""LLM interface module for the PDF RAG Application.

This module provides functionality to:
1. Interface with OpenAI-compatible APIs
2. Generate prompts from queries and retrieved chunks
3. Generate responses using language models
"""
